...
INSERT INTO usuarios (id, login, password) VALUES (1, 'Cristiano', '$2a$10$B9vcQFyCeVl1gZI1ro1mN.gtpT9SC7B7Scgk7XvtRFVhTKHHT5XJW');

-- INSERT INTO usuarios (id, login, password) VALUES (2, 'Maikon', '5678');
INSERT INTO usuarios (id, login, password) VALUES (2, 'Davi', '$2a$10$2oM3dWrYS8wlgD0uSLlhhOEwr.bZcCao/iOUcdS0VV0KDFyTTlXkG');

-- INSERT INTO usuarios (id, login, password) VALUES (3, 'Jeff', '9012');
INSERT INTO usuarios (id, login, password) VALUES (3, 'Lorena', '$2a$10$AVhulb0dkxjsl8amv9YgrOJdWf07nplzomWgLF3XiWSvmneS.5BOS');
